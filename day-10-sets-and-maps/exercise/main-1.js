{
   ...
   const mapCountries = new Set(countries)
   console.log(mapCountries)

   const countryCharCount = {}

   for (let i = 0; i < countries.length; i++) {
      const country = countries[i]
      const charCount = country.length
      countryCharCount[country] = charCount
   }
...

{
   ...
   const mostSpokenLanguages = (country, count) => {
